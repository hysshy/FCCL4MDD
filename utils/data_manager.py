...
from utils.data import Derm7pt, JSIEC
import torch, copy
import random
...
class DataManager(object):
    def __init__(self, dataset_name, shuffle, seed, init_cls, increment, train_data=None, test_data=None):
        self.dataset_name = dataset_name
        self._setup_data(dataset_name, shuffle, seed, train_data, test_data)
    ...
    def _setup_data(self, dataset_name, shuffle, seed, trainPath=None, testPath=None):
        idata = _get_idata(dataset_name)
        idata.download_data(trainPath, testPath)
